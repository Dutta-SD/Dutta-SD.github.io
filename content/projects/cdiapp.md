...
date: 2022-09-01
summary: "A CNN-based crop-disease classifier paired with a Gemini-powered remedy recommender. Shortlisted for Smart India Hackathon 2022 national finals."
tags: ["machine-learning", "cnn", "llm", "hackathon"]
weight: 1
---

**CDIApp** is a mobile-friendly tool that lets a farmer photograph a diseased leaf and receive (a) an identification of the disease and (b) a suggested remedy. Built for **Smart India Hackathon 2022** and shortlisted for the national finals.
